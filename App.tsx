...
const App: React.FC = () => {
  ...
  const handleSubmit = () => {
    if (textValue.trim() === '') {
      Alert.alert('Error', 'Tolong masukkan teks.');
      return;
    }
    ...
    <View style={styles.container}>
      <ScrollView style={styles.scrollView}>
        ...
        <Image
          style={styles.image}
          source={{
            uri: 'https://png.pngtree.com/png-vector/20230531/ourlarge/pngtree-anime-girl-coloring-pages-vector-png-image_6787130.png',
          }}
        />
        <TextInput
          style={styles.input}
